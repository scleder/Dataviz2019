...
Annual_BJS_Data <- read_excel("//Sarah/U. of Michigan/Semester 2/SW 670 001/R Data/Annual BJS /Annual BJS Data.xlsx")
...
library(jpeg)
library(grid)
img <- readPNG("//Sarah/U. of Michigan/Semester 2/SW 670 001/QGIS/QGIS Assignment/QGIS Assignment.png") 
grid.raster(img)
```
...
library(png) 
library(grid)
tab <- readPNG("/Sarah/U. of Michigan/Semester 2/SW 670 001/Tableau/Final Product/Incarcerated.png") 
grid.raster(tab)
```
...
library(png) 
library(grid)
img <- readPNG("/Sarah/U. of Michigan/Semester 2/SW 670 001/Tableau/Final Product/Worksheet.png") 
grid.raster(img)
```
...
library(png) 
library(grid)
img <- readPNG("/Sarah/U. of Michigan/Semester 2/SW 670 001/Tableau/Final Product/State & Race.png") 
grid.raster(img)
```
...
library(png) 
library(grid)
img <- readPNG("/Sarah/U. of Michigan/Semester 2/SW 670 001/Tableau/Final Product/State & Race - Texas.png") 
grid.raster(img)
```
