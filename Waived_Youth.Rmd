...
The youth and adult court systems have existed as separate entities since 1899. Fastforward nearly one hundred years to the 1980s and the juvenile system is largely seen as too lenient on the youth. Because of perceptions and predictions of rising youth crime rates, the vast majority of states enacted harsher laws that eased the transfer of a youth from the juvenile system to its adult counterpart. These measures included lowering the minimum age to be tried as an adult, longer sentences, "once an adult, always an adult" provisions, and a more explicit focus on retribution. 

The Office of Jucenile Justice and Delinquency Prevention has been tracking juvenile court trends since 1985 and [analyzing delinquency cases](https://www.ojjdp.gov/ojstatbb/ezajcs/asp/selection.asp) since 2005.
